        ...
        <main class="w-full md:w-3/4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($products as $product)
                    <div
                        class="bg-[#1e293b] rounded-2xl overflow-hidden border border-gray-700 shadow-xl flex flex-col group transition-all hover:border-indigo-500">
                        ...
                        <div class="p-5 flex-1 flex flex-col justify-between text-white">
                            <div>
                                ...
                                <p class="text-indigo-400 text-xs font-bold uppercase mt-2">
                                    {{ $product->category->name ?? 'Fútbol' }}</p>
                            </div>
                ...
                @empty
                    <div
                        class="col-span-full py-20 text-center text-gray-500 border-2 border-dashed border-gray-700 rounded-2xl">
